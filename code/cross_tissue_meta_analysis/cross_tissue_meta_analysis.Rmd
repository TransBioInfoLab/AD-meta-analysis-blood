---
title: "Cross-tissue Meta-analysis dataset - using bacon inflation- and bias-corrected P-values"
...
blood.meta_analysis <- readr::read_csv(
  "~/TBL Dropbox/Tiago Silva/AD-meta-analysis-blood-samples/analysis_results/meta_analysis/Logistic_regression_model/AD_vs_CN/meta_analysis_glm_fixed_effect_ADNI_and_AIBL_AD_vs_CN_single_cpg_annotated.csv"
  )
```
